...
export default function DashboardDemo() {
  ...
  return (
    <div className={'flex flex-col space-y-6 pb-36'}>
      ...
      >
        <Tile>
          <Tile.Heading>This Month's Revenue</Tile.Heading>
        ...
        <Tile>
          <Tile.Heading>Today's Revenue</Tile.Heading>
        ...
        <Tile>
          <Tile.Heading>Calls</Tile.Heading>
        ...
        <Tile>
          <Tile.Heading>Rental Page Visitors</Tile.Heading>
        ...
        <Tile>
          <Tile.Heading>Departures</Tile.Heading>
      ...
      <div>
        <Tile>
          <Tile.Heading>On-the road RVs</Tile.Heading>
  ...
  return (
    <div>
      ...
      <p className={'text-gray-500 dark:text-gray-400'}>
        <span>Here&apos;s what is happening in on your lot?</span>
      </p>
    </div>
  );
}
...
function CustomersTable() {
  return (
    <table className={'Table'}>
      ...
      <tbody>
        <tr>
          <td>Winnebago Adventurer</td>
          <td>Pippin Oddo</td>
          <td>2024-05-10</td>
          <td>2024-05-20</td>
          <td>
            <Tile.Badge trend={'up'}>In Progress</Tile.Badge>
          </td>
        </tr>

        <tr>
          <td>Fleetwood Bounder</td>
          <td>Väinö Pánfilo</td>
          <td>2024-04-22</td>
          <td>2024-05-01</td>
          <td>
            <Tile.Badge trend={'stale'}>Returned</Tile.Badge>
          </td>
        </tr>
        ...
        <tr>
          <td>Coachmen Freelander</td>
          <td>Adhelm Otis</td>
          <td>2024-05-01</td>
          <td>2024-05-10</td>
          <td>
            <Tile.Badge trend={'down'}>Overdue</Tile.Badge>
          </td>
        </tr>
      </tbody>
    </table>
