      ...
      <Container>
        ...
        >
          <div className={"flex w-full flex-1 flex-col items-center space-y-8"}>
            ...
            <HeroTitle>
              <span>A Complete RV Rental Management Solution</span>
              <span
                className={
            ...
            <SubHeading className={"text-center"}>
              <span>
                Manage bookings, optimize your operations, reduce costs, and
                boost customer
              </span>
              <span>
                satisfaction, all without giving your customer data to
                Outdoorsy!
              </span>
              <span>
                This all-in-one platform is designed{" "}
                <em>
                  <strong>by</strong>
                </em>{" "}
            ...
            <div className={"flex flex-col items-center space-y-4"}>
              ...
              We are building a complete RV Rental Management solution for your business and want your feedback!
              </span>
            </div>
          </div>
        </div>
        ...
        >
          <Image
            ...
            width={2688}
            height={1824}
            src="https://i.imgur.com/wfX7CtZ.png"
      ...
      <Container style={{ marginTop: "0px !important" }}>
        <div className={"flex flex-col items-center space-y-8 text-center"}>
          <div className={"flex flex-col space-y-2.5"}>
            <Heading type={2}>
              {" "}
              RV Rent Pro is so much more than just a reservation system.
            </Heading>

            <SubHeading>
              It is truly an RV Rental Business Management Solution that helps you manage all aspects of your business; it is designed by RV Rental Businesses for RV Rental Businesses
              ...
              <br />
              …does not give your customer data to Outdoorsy for marketing
              purposes.
              <br />
              …does not give your proprietary business data to Outdoorsy for
              their benefit.
              <br />
              …provides the features and functions that serve your interests and
              help you succeed!
              <br />
              …provides the lowest possible credit card processing fees (you pay
              4% with Wheelbase)
              <br />
              …enables full conversion tracking so you can see where your
        ...
        <div className="grid w-full grid-cols-1 gap-2 md:grid-cols-2 lg:grid-cols-2 lg:gap-4 xl:gap-6 center-grid">
          <div className="flex-auto shadow-primary-600/5 john-shadow-600 shadow-lg p-4 xl:p-8 shadow-lg-imp text-center">
            ...
            <div className="py-2.5">
              <div className="flex flex-col space-y-3 text-base text-gray-500">
                <p>
                  Core function to manage online reservations, widget/iframe
                  integration with your website or choose one of our optimized
                  website templates and configure for your business.
                </p>
              </div>
            </div>
          </div>
          <div className="flex-auto shadow-primary-600/5 john-shadow-600 shadow-lg p-4 xl:p-8 shadow-lg-imp text-center">
            ...
            <div className="py-2.5">
              <div className="flex flex-col space-y-3 text-base text-gray-500">
                <p>
                  Integrates with QBO or Xero & automates 90% of your
                  bookkeeping functions. Provides detailed invoicing, payment
                  tracking, batch deposit reconciliation and even integrates
                  with the Leaseback Module to record income, expenses and
                  payments to Leaseback Owners.
                </p>
                <p>Save hundreds of man-hours per year!</p>
              </div>
            </div>
          </div>
          <div className="flex-auto shadow-primary-600/5 john-shadow-600 shadow-lg p-4 xl:p-8 shadow-lg-imp text-center">
            ...
            <div className="py-2.5">
              <div className="flex flex-col space-y-3 text-base text-gray-500">
                <p>
                  You no longer need to switch back-and-forth to separate fleet
                  maintenance software or enter a rental unit into multiple
                  databases; you&apos;ll have built-in maintenance templates
                  that you can customize to suit your fleet needs.
                </p>
                <p>
                  You’ll be notified when maintenance is due, and you can track
                  Repair Requests and Work Orders all within an integrated
                  system that knows when the next reservation is and helps you
                  manage the Chaos of RV Rentals!
                </p>
              </div>
            </div>
          </div>
          <div className="flex-auto shadow-primary-600/5 john-shadow-600 shadow-lg p-4 xl:p-8 shadow-lg-imp text-center">
            ...
            <div className="py-2.5">
              <div className="flex flex-col space-y-3 text-base text-gray-500">
                <p>
                  An integrated App for your device, also accessed via the
                  dashboard, that provides a thorough yet simple & customizable
                  process for moving a rental unit from “just came back” to
                  “ready for departure”.{" "}
                </p>
                <p>
                  No more failure to detect damage, no more wondering
                  what&apos;s left
                </p>
              </div>
            </div>
              ...
              <div className="flex flex-col justify-center space-y-4 px-1.5">
                ...
                <div>
                  <h3 className="text-4xl xl:text-5xl font-medium text-dark lg:!leading-[1.2em]">
                    ...
                    < br/>
                    <span className=" lg:text-2xl text-gray-500">
                   Take advantage of powerful reservation management SW that easily plugs in to your existing website, or choose from a selection of professionally designed and optimized website templates to kick your web traffic and reservations into high gear!
                    </span>
                  </h3>
                </div>
              </div>
          ...
          <div className="grid w-full grid-cols-1 gap-2 md:grid-cols-2 lg:grid-cols-4 lg:gap-4 xl:gap-6">
            <div className="flex-auto shadow-primary-600/5 john-shadow-600 shadow-lg p-4 xl:p-8 shadow-lg-imp">
              <h3 className="flex flex-col space-y-3 text-lg font-semibold xl:text-xl dark:text-white">
                ...
                <span>Payment Processing without Added Fees </span>
              </h3>
              <div className="py-2.5">
                <div className="flex flex-col space-y-3 text-base text-gray-500">
                  <p>
                  Tired of paying thousands or tens of thousands in extra credit card fees?
                  </p>
                  <p>
                    Choose your vendor, negotiate your best rates, and keep the savings where they belong, in your pocket, not in your competition&apos;s pocket!
                  </p>
                </div>
              </div>
            </div>
            <div className="flex-auto shadow-primary-600/5 john-shadow-600 shadow-lg p-4 xl:p-8 shadow-lg-imp">
              ...
              <div className="py-2.5">
                <div className="flex flex-col space-y-3 text-base text-gray-500">
                  <p>Tailor the software to fit your business operations.</p>
                  <p>
                  Choose vehicle options, add-ons, pricing and scheduling rules and more to suit your business needs, ensuring your business can operate the way you need it to.
                  </p>
                </div>
              </div>
            </div>
            <div className="flex-auto shadow-primary-600/5 john-shadow-600 shadow-lg p-4 xl:p-8 shadow-lg-imp">
              <h3 className="flex flex-col space-y-3 text-lg font-semibold xl:text-xl dark:text-white">
                ...
                <span>Integrated Insurance Solutions </span>
              </h3>
              <div className="py-2.5">
                <div className="flex flex-col space-y-3 text-base text-gray-500">
                  <p>
                  Choose from multiple integrated insurance providers for the solution that best meets your needs for episodic or inclusive insurance.
                  </p>
                </div>
              </div>
            </div>
            <div className="flex-auto shadow-primary-600/5 john-shadow-600 shadow-lg p-4 xl:p-8 shadow-lg-imp">
              ...
              <div className="py-2.5">
                <div className="flex flex-col space-y-3 text-base text-gray-500">
                  <p>
                  For each rental, you should be able to know exactly how that customer found you.
                  </p>
                  <p>
                  With Conversion Tracking you&apos;ll have a clear picture of which marketing efforts (& dollars) are bringing in the most rentals so you can optimize your marketing budget for maximum effectiveness.
              ...
              <div className="w-full flex-col space-y-2">
                <div className="flex flex-col justify-center space-y-4 px-1.5">
                  ...
                  <div>
                    ...
                    <br/>
                      <span className=" lg:text-2xl text-gray-500">
                      Integrates with QuickBooks online or Xero & automates 90% of your bookkeeping functions. Provides detailed invoicing, payment tracking, batch deposit reconciliation and even integrates with the Leaseback Module to record income, expenses and payments to Leaseback Owners. Save hundreds of man-hours per year!
          ...
          <div className="grid w-full grid-cols-1 gap-2 md:grid-cols-2 lg:grid-cols-4 lg:gap-4 xl:gap-6">
            <div className="flex-auto shadow-primary-600/5 john-shadow-600 shadow-lg p-4 xl:p-8 shadow-lg-imp">
              ...
              <div className="py-2.5">
                <div className="flex flex-col space-y-3 text-base text-gray-500">
                  <p>
                  Automatically creates customers, invoices, payments, deposits and more for every reservation. Add a new vehicle to the fleet, and the appropriate vehicle-specific accounts are created. 
                  </p>
                  <p>
                  Track income and expenses in detail so you can make informed business decisions.
                  </p>
                </div>
              </div>
            </div>
            <div className="flex-auto shadow-primary-600/5 john-shadow-600 shadow-lg p-4 xl:p-8 shadow-lg-imp">
              ...
              <div className="py-2.5">
                <div className="flex flex-col space-y-3 text-base text-gray-500">
                  <p>
                    Easily reconcile batch deposits, enhancing the accuracy and
                    timeliness of your financial reports.
                  </p>
                  <p>
                    Reduce the time spent on reconciling accounts and increase
            ...
            <div className="flex-auto shadow-primary-600/5 john-shadow-600 shadow-lg p-4 xl:p-8 shadow-lg-imp">
              ...
              <div className="py-2.5">
                <div className="flex flex-col space-y-3 text-base text-gray-500">
                  <p>
                    Fully integrated with the Leaseback Module, our system
                    records income, expenses, and payments related to Leaseback
                    Owners.
                  </p>
                  <p>
                    Manage and streamline every aspect of your leaseback
            ...
            <div className="flex-auto shadow-primary-600/5 john-shadow-600 shadow-lg p-4 xl:p-8 shadow-lg-imp">
              ...
              <div className="py-2.5">
                <div className="flex flex-col space-y-3 text-base text-gray-500">
                  <p>
                    Save hundreds of man-hours annually with automation and
                    integration features designed to streamline complex
                    financial tasks and reporting requirements.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="w-full flex-col space-y-8 flex lg:w-8/12">
              <div className="flex flex-col justify-center space-y-4 px-1.5">
                ...
                <div>
                  ...
                  <br/>
                    <span className=" lg:text-2xl text-gray-500">
                    You don&apos;t need separate software to manage the maintenance of your fleet. With our integrated solution, you can borrow and customize the included maintenance templates to create the perfect maintenance schedule for your entire fleet. 
                    </span>
                  </h3>
                </div>
              </div>
          ...
          <div className="grid w-full grid-cols-1 gap-2 md:grid-cols-2 lg:grid-cols-4 lg:gap-4 xl:gap-6">
            <div className="flex-auto shadow-primary-600/5 john-shadow-600 shadow-lg p-4 xl:p-8 shadow-lg-imp">
              ...
              <div className="py-2.5">
                <div className="flex flex-col space-y-3 text-base text-gray-500">
                  <p>
                    Access built-in maintenance templates that are fully
                    customizable to match your fleet&apos;s specific
                    requirements.{" "}
                  </p>
                  <p>
                    Tailor maintenance schedules, checklists, and procedures
                    directly within our system to ensure your fleet operates at
                    peak efficiency.
                  </p>
                </div>
              </div>
            ...
            <div className="flex-auto shadow-primary-600/5 john-shadow-600 shadow-lg p-4 xl:p-8 shadow-lg-imp">
              ...
              <div className="py-2.5">
                <div className="flex flex-col space-y-3 text-base text-gray-500">
                  <p>
                  Stay ahead of maintenance needs with automated alerts. You&apos;ll receive notifications when maintenance is due, ensuring that no task goes unnoticed or delayed. With our integrated system, mileage, generator hours and other data is automatically updated when an RV is checked in after a rental.
            ...
            <div className="flex-auto shadow-primary-600/5 john-shadow-600 shadow-lg p-4 xl:p-8 shadow-lg-imp">
              ...
              <div className="py-2.5">
                <div className="flex flex-col space-y-3 text-base text-gray-500">
                  <p>
                    Efficiently track and manage Repair Requests and Work Orders
                    within our system.
                  </p>
                  <p>
                    Our integrated approach ensures that you are always aware of
                    maintenance statuses, upcoming reservations, and available
                    units.
                  </p>
                </div>
              </div>
            ...
            <div className="flex-auto shadow-primary-600/5 john-shadow-600 shadow-lg p-4 xl:p-8 shadow-lg-imp">
              ...
              <div className="py-2.5">
                <div className="flex flex-col space-y-3 text-base text-gray-500">
                  <p>
                    Designed specifically to handle the challenges of RV
                    rentals, our system helps you manage the chaos of
                    fluctuating schedules, varying maintenance needs, and
                    constant customer demands.
                  </p>
                  <p>
                    Keep your fleet in top condition while ensuring smooth and
              ...
              <div className="w-full flex-col space-y-2">
                <div className="flex flex-col justify-center space-y-4 px-1.5">
                  ...
                  <div>
                    ...
                    <br/>
                      <span className=" lg:text-2xl text-gray-500">
                      An integrated App for your device, also accessed via your dashboard, that guides your team through a simple yet thorough & customizable process for moving a rental unit from “just came back from rental” to “ready for the next departure”. No more failure to detect damage, no more wondering what the status is for any particular rental unit. The precise status of every unit in your fleet is available at a glance with clear indications of what is still needed to get each unit ready for rental.
                      </span>
                    </h3>
                  </div>
                </div>
          ...
          <div className="grid w-full grid-cols-1 gap-2 md:grid-cols-2 lg:grid-cols-4 lg:gap-4 xl:gap-6">
            <div className="flex-auto shadow-primary-600/5 john-shadow-600 shadow-lg p-4 xl:p-8 shadow-lg-imp">
              ...
              <div className="py-2.5">
                <div className="flex flex-col space-y-3 text-base text-gray-500">
                  <p>
                    Customize the return process to fit your business needs.{" "}
                  </p>
                  <p>
                    Set up tailored checklists and procedures to ensure every
                    rental unit is thoroughly inspected and prepared for the
                    next customer.
                  </p>
                </div>
              </div>
            ...
            <div className="flex-auto shadow-primary-600/5 john-shadow-600 shadow-lg p-4 xl:p-8 shadow-lg-imp">
              <h3 className="flex flex-col space-y-3 text-lg font-semibold xl:text-xl dark:text-white">
                ...
                <span>Quickly Record Damage & Other Issues</span>
              </h3>
              <div className="py-2.5">
                <div className="flex flex-col space-y-3 text-base text-gray-500">
                  <p>
                    Our system enhances your ability to detect any damage as
                    soon as a unit returns. Eliminate the risk of missed issues
                    with detailed, step-by-step inspection guides, ensuring that
                    every potential problem is addressed promptly.{" "}
                  </p>
                </div>
              </div>
            </div>
            <div className="flex-auto shadow-primary-600/5 john-shadow-600 shadow-lg p-4 xl:p-8 shadow-lg-imp">
              ...
              <div className="py-2.5">
                <div className="flex flex-col space-y-3 text-base text-gray-500">
                  <p>
                    Automatically track and manage all necessary steps to get a
                    rental unit back in service.
                  </p>
                  <p>
                    From cleaning to maintenance checks, our app guides your
                    staff through each task, leaving no room for error or
                    confusion.
                  </p>
                </div>
              </div>
            ...
            <div className="flex-auto shadow-primary-600/5 john-shadow-600 shadow-lg p-4 xl:p-8 shadow-lg-imp">
              ...
              <div className="py-2.5">
                <div className="flex flex-col space-y-3 text-base text-gray-500">
                  <p>
                    Stay informed with real-time updates throughout the return
                    process.{" "}
                  </p>
                  <p>
                    Know exactly what&apos;s been completed and what&apos;s
                    still pending at a glance, ensuring that nothing is
                    overlooked.
                  </p>
                </div>
              </div>
...
<div className="flex flex-col space-y-16">
        <div className="flex flex-col items-center space-y-8 lg:flex-row lg:space-y-0 items-center lg:justify-between lg:space-x-16 flex-col-reverse lg:flex-row space-y-0 [&amp;>:first-child]:mt-8 lg:[&amp;>:first-child]:mt-0">
          <div className="w-full lg:w-8/12 px-2">
            <div><video className="rounded-xl my-6" width="100%" height="auto" autoPlay loop muted><source src="https://makerkit.dev/assets/install-command.mp4" type="video/mp4" /></video>
          ...
          <FeatureShowcaseContainer>
            <LeftFeatureContainer>
              <div className={"flex flex-col space-y-4"}>
                ...
                <SubHeading as={"h3"}>
                  Streamline the booking process in your own website with our
                  embedde reservation system
                </SubHeading>
              </div>
...
<div className={"flex flex-col items-center space-y-8 text-center"}>
            ...
            <div className={"flex flex-col space-y-2.5"}>
              ...
              <SubHeading>
                Start with our free trial and discover how easy it is to take control of
                your operations.
              </SubHeading>
              <br/>
            </div>
    ...
    <div className="p-2 shadow-primary-500/5 mini-shadow-600 shadow-md">
     ...
     {/*<!-- Multi-Factor Auth -->*/}
          <div className="p-2 shadow-primary-500/5 mini-shadow-600 shadow-md">
            ...
            <div className="py-2.5">
              <div className="flex flex-col space-y-3 text-base dark:text-gray-400">
                Yes, we&apos;ve actually packaged industry expertise so you can
                benefit from the processes, checklists, documents and best
                practices from industry experts across North America! RV Rent
                Pro includes customizable templates for Rental Agreements,
                Leaseback Agreements, Send-out and Return Checklists, Vehicle
                Maintenance Schedules and detailed written processes for all the
                challenging activities your business must accomplish!
              </div>
            </div>
          </div>
          {/*<!-- Payments -->*/}
          <div className="p-2 shadow-primary-500/5 mini-shadow-600 shadow-md">
            ...
            <div className="py-2.5">
              <div className="flex flex-col space-y-3 text-base dark:text-gray-400">
                Digitize all send-out and return documents & includes digital
                signatures. You can utilize documents from our extensive library
                and even customize them to suit your needs.
              </div>
            </div>
          </div>
          {/*<!-- Customer Portal -->*/}
          <div className="p-2 shadow-primary-500/5 mini-shadow-600 shadow-md">
            ...
            <div className="py-2.5">
              <div className="flex flex-col space-y-3 text-base dark:text-gray-400">
                Offers extensive website and SEO services, content creation, PPC
                management, and more, with options for customization based on
                your needs.
              </div>
            </div>
          </div>
          ...
          <div className="p-2 shadow-primary-500/5 mini-shadow-600 shadow-md">
            ...
            <div className="py-2.5">
              <div className="flex flex-col space-y-3 text-base dark:text-gray-400">
                Provides detailed capabilities to search, sort, filter, and
                export a host of different data related to your vehicles,
                reservations, customers and owners, enhancing strategic
          ...
          <div className="p-2 shadow-primary-500/5 mini-shadow-600 shadow-md">
            ...
            <div className="py-2.5">
              <div className="flex flex-col space-y-3 text-base dark:text-gray-400">
                Shows your businesses key performance data at a glance and
                allows for comparison reporting of performance data by previous
                periods, aiding you in your business performance assessments and
                strategic planning.
              </div>
            </div>
          </div>
          ...
          <div className="p-2 shadow-primary-500/5 mini-shadow-600 shadow-md">
            ...
            <div className="py-2.5">
              <div className="flex flex-col space-y-3 text-base dark:text-gray-400">
                Provides capabilities to search, sort, filter, and export data
                related to vehicles, reservations, customers, and owners,
          ...
          <div className="p-2 shadow-primary-500/5 mini-shadow-600 shadow-md">
            ...
            <div className="py-2.5">
              <div className="flex flex-col space-y-3 text-base dark:text-gray-400">
                Provides options to manage your vehicle insurance policies,
                including additions, edits, and removals; integrates with
                third-party insurance providers to streamline the rental
                insurance process.
              </div>
            </div>
          </div>
          ...
          <div className="p-2 shadow-primary-500/5 mini-shadow-600 shadow-md">
            ...
            <div className="py-2.5">
              <div className="flex flex-col space-y-3 text-base dark:text-gray-400">
                Provides a robust internal messaging system that allows for
                communication within the platform, including follow-up reminders
          ...
          <div className="p-2 shadow-primary-500/5 mini-shadow-600 shadow-md">
            ...
            <div className="py-2.5">
              <div className="flex flex-col space-y-3 text-base dark:text-gray-400">
                Allows extensive customization of the software&apos;s features
                and settings, including user access levels, payment
                configurations, and visual aspects of the user interface.
              </div>
            </div>
          </div>
          <div className="p-2 shadow-primary-500/5 mini-shadow-600 shadow-md">
            ...
            <div className="py-2.5">
              <div className="flex flex-col space-y-3 text-base dark:text-gray-400">
                RV Rent Pro does not compete with you, quite the opposite, in
                fact. Our goal is to facilitate collaboration among RV Rental
                businesses across America and Canada, promoting strength
                together through the sharing of knowledge, best practices,
                industry trends, and collective purchasing of insurance and
                other products.
              </div>
            </div>
          </div>
      ...
      <Container>
        <SubHeading>
          <span style={{ textAlign: "center" }}>Plans comparison</span>
        </SubHeading>
        <DemoExample />
      </Container>
        ...
        <div className="flex flex-col items-center justify-center space-y-24 py-12">
          <div className="flex max-w-3xl flex-col items-center space-y-4 text-center">
            <div className="flex flex-col items-center space-y-2">
              ...
              <strong className="text-primary-500">Features</strong>
            </div>
            ...
            <div className="grid gap-12 lg:grid-cols-3">
              <div className="flex flex-col space-y-3 text-center">
                ...
                <div className="text-gray-500 dark:text-gray-400">
                  Comprehensive tools to manage bookings, schedules, and
              ...
              <div className="flex flex-col space-y-3 text-center">
                ...
                <div className="text-gray-500 dark:text-gray-400">
                  Keep your fleet in peak condition with automated maintenance
              ...
              <div className="flex flex-col space-y-3 text-center">
                ...
                <div className="text-gray-500 dark:text-gray-400">
                  Integrate seamlessly with accounting software like QuickBooks
                  for real-time financial tracking and reporting.
                </div>
              </div>
              <div className="flex flex-col space-y-3 text-center">
                <FeatureIcon>
                ...
                <div className="text-gray-500 dark:text-gray-400">
                  Enhance customer satisfaction with CRM tools that streamline
              ...
              <div className="flex flex-col space-y-3 text-center">
                ...
                <div className="text-gray-500 dark:text-gray-400">
                  Go paperless with digital document management, including
                  rental agreements and customer signatures.
                </div>
              </div>
              <div className="flex flex-col space-y-3 text-center">
                <FeatureIcon>
                ...
                <div className="text-gray-500 dark:text-gray-400">
                  Leverage built-in marketing tools to promote your services,
                  reach wider audiences, and boost bookings.
                </div>
              </div>
            </div>
          </div>
  ...
  return (
    ...
    >
      <span className={"flex items-center space-x-2"}>
        <span>Help Shape The Software</span>
        <ChevronRightIcon
          className={
